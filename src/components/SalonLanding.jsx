...
export default function SalonLanding() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="fixed right-3 md:right-6 bottom-20 md:bottom-6 z-50 flex flex-col gap-3 md:gap-4 max-w-[calc(100vw-1.5rem)]">
        {/* WhatsApp Button */}
        <motion.a
        ...
        >
          ...
          <span className="hidden md:block absolute right-16 top-1/2 -translate-y-1/2 bg-foreground text-background px-3 py-1 rounded-md text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            Chat on WhatsApp
          </span>
        </motion.a>
