  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="fixed right-3 md:right-6 bottom-6 z-50 flex flex-col gap-3 md:gap-4">
        ...
        >
          <div className="w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300">
        ...
        <motion.a
          ...
          className="group relative"
        >
          <div className="w-14 h-14 md:w-16 md:h-16 bg-white rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-gray-100">
