    ...
    <>
      ...
      <div className="fixed right-3 md:right-6 bottom-6 z-[9999] flex flex-col gap-3 md:gap-4">
        ...
        <a
          ...
          className="group relative w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95"
        >
          ...
          <span className="hidden md:block absolute right-20 top-1/2 -translate-y-1/2 bg-foreground text-background px-3 py-1.5 rounded-md text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            Chat on WhatsApp
          </span>
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group relative w-14 h-14 md:w-16 md:h-16 bg-white rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:scale-110 active:scale-95"
        >
